...
class RegexpOperatorTest extends BaseUnitTest {
  ...
  private static Stream<Arguments> validArgumentProvider() {
    return Stream.of(
        Arguments.of(FilterOperator.REGEXP, 1, 0),
        Arguments.of(FilterOperator.IS_BLANK, 0, 1),
        Arguments.of(FilterOperator.IS_NOT_BLANK, 1, 0)
    );
  }
