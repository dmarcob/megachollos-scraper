...
class NumericOperatorTest extends BaseUnitTest {
  ...
  private static Stream<Arguments> validArgumentProvider() {
    return Stream.of(
        Arguments.of(FilterOperator.GREATER_THAN, 1, 0),
        Arguments.of(FilterOperator.GREATER_THAN_OR_EQUAL_TO, 1, 0),
        Arguments.of(FilterOperator.LESS_THAN, 1, 0),
        Arguments.of(FilterOperator.LESS_THAN_OR_EQUAL_TO, 1, 0)
    );
  }
