...
class NullityOperatorTest extends BaseUnitTest {

  private static final String FIELD = "field";
  private static final String VALUE = "value";

  @InjectMocks
  private NullityOperator operator;

  private static Stream<Arguments> validArgumentProvider() {
    return Stream.of(
        Arguments.of(FilterOperator.IS_NOT_NULL, 1, 0),
        Arguments.of(FilterOperator.IS_NULL, 0, 1)
    );
  }
